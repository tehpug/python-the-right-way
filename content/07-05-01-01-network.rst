...
`Twisted <https://twistedmatrix.com/trac/>`_ یک فریم‌ورک event-driven برای کار با شبکه است که از پروتکل های مختلف پشتیبانی می کند، برای اطلاعات بیشتر در مورد Twisted به صفحه `ویکی‌پیدا <https://en.wikipedia.org/wiki/Twisted_(software)>`_ ‌ پروژه مراجعه کنید.
