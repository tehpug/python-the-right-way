...
با این حال معمولا توصیه می شود در شروع یادگیری یک زبان برنامه نویسی، از ویراستارهای ساده تر استفاده شود و زمانی که تسلط کافی در برنامه نویسی به دست آمد از ویراستارهای پیشرفته تری نیز بهره مند شوند
...
به جز IDLE که یک ویراستار میانه در بین ویراستار های ساده و ویراستار های پیشرفته است باقی این ویراستار ها تنها امکانات ساده و اولیه مانند رنگ بندی و حداکثر فرمت بندی کد ها را فراهم می کنند
...
در این بین ویژوال استودیو مایکروسافت تنها بر روی ویندوز قابل استفاده است ولی دیگر ویراستار ها هم بر روی ویندوز و هم بر روی لینوکس قابل استفاده هستند
